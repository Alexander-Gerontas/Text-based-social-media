...
import com.alg.social_media.post.adapter.application.port.in.CommentService;
import com.alg.social_media.post.adapter.application.port.in.PostService;
import com.alg.social_media.post.adapter.application.port.out.CommentRepository;
import com.alg.social_media.post.adapter.application.port.out.PostRepository;
import com.alg.social_media.post.adapter.application.service.CommentServiceImpl;
import com.alg.social_media.post.adapter.application.service.PostServiceImpl;
import com.alg.social_media.post.adapter.domain.model.Comment;
import com.alg.social_media.post.adapter.domain.model.Post;
import com.alg.social_media.post.adapter.out.persistance.CommentRepositoryImpl;
import com.alg.social_media.post.adapter.out.persistance.PostRepositoryImpl;
