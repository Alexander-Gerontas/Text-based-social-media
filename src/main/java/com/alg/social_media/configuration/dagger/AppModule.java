...
import static com.alg.social_media.configuration.handler.GlobalControllerExceptionHandler.exceptionHandler;
import static com.alg.social_media.configuration.handler.GlobalControllerExceptionHandler.runtimeExceptionHandler;
import static org.modelmapper.convention.MatchingStrategies.STRICT;

import com.alg.social_media.account.adapter.application.port.in.AccountService;
import com.alg.social_media.account.adapter.application.port.in.CommentService;
import com.alg.social_media.account.adapter.application.port.in.FollowService;
import com.alg.social_media.account.adapter.application.port.in.PostService;
...
import com.alg.social_media.account.adapter.application.service.AccountServiceImpl;
import com.alg.social_media.account.adapter.application.service.CommentServiceImpl;
import com.alg.social_media.account.adapter.application.service.FollowServiceImpl;
import com.alg.social_media.account.adapter.application.service.PostServiceImpl;
...
import com.alg.social_media.account.adapter.out.persistance.AccountRepositoryImpl;
import com.alg.social_media.account.adapter.out.persistance.CommentRepositoryImpl;
import com.alg.social_media.account.adapter.out.persistance.FollowRepositoryImpl;
import com.alg.social_media.account.adapter.out.persistance.PostRepositoryImpl;
